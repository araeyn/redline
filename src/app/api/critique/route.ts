...
const critiquePrompt = `
  ...
  Identify 8-14 specific areas for improvement.
  ...
  If the same kind of issue appears in more than one place, repeat that category with different coordinates instead of forcing fake variety.
